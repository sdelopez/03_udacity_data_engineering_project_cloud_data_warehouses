...
# GLOBAL VARIABLES - load AWS informations
LOG_DATA = config.get("S3","LOG_DATA")
LOG_PATH = config.get("S3", "LOG_JSONPATH")
SONG_DATA = config.get("S3", "SONG_DATA")
SONG_DATA_SUBSET = config.get("S3", "SONG_DATA_SUBSET")
...
# STAGING TABLES - COPY/UPSERT DATA
...
# for developpement purpose to avoid long loading to staging table, use a subset of SONG_DATA
# replace in the query SONG_DATA by SONG_DATA_SUBSET
